...
[<assembly: AssemblyTitleAttribute("TryingOutDateTime.Tests")>]
[<assembly: AssemblyProductAttribute("TryingOutDateTime")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "TryingOutDateTime.Tests"
    let [<Literal>] AssemblyProduct = "TryingOutDateTime"
